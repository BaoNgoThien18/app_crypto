...
<main class="main-content w-full px-[var(--margin-x)] pb-8" style="height:auto;">
    <div class="mt-12 text-center">
        ...
        <form id="send" method="POST">
            ...
            <div>
                <label class="block "> <span class="font-medium text-slate-600 dark:text-navy-100">To</span>

                    <select class="mt-3 form-input rounded w-full border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent input value1" name="to" id="to">
