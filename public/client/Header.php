...
foreach ($my_coin as $key => $value) {
    $__COIN = $BNZ->get_row("SELECT * FROM `coin` WHERE `symboy` =  '" . $key . "' ");
    $total_money += (float)$value * (float)$__COIN['price'];
}


$total_money = auto_decimal_format($total_money, 2)
...
<head>
    ...
    <!-- CSS Assets -->
    <link rel="stylesheet" href="<?= $url ?>assets/template/app.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <!-- Javascript Assets -->
    <script src="<?= $url ?>assets/template/app.js" defer=""></script>
    <!-- Fonts -->
